    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-start gap-6 sm:gap-12">
        ...
        <div className="flex-shrink-0">
          <div className={`text-sm uppercase tracking-wider ${isPast ? 'text-dark/50' : 'text-dark/60'}`}>
        ...
        <div className="flex-1 border-t border-dark/10 pt-4 sm:pt-0 sm:border-t-0 sm:border-l sm:pl-12">
          <div className="flex flex-wrap items-center gap-3 mb-3">
            <h3 className={`text-xl sm:text-2xl font-normal group-hover:text-dark/70 transition-colors ${isPast ? 'text-dark/70' : 'text-dark'}`}>
              {event.title}
            </h3>
            {!isPast && (
          ...
          <div className={`space-y-1 text-sm ${isPast ? 'text-dark/50' : 'text-dark/60'}`}>
          ...
          <p className={`mt-4 text-sm leading-relaxed line-clamp-2 ${isPast ? 'text-dark/50' : 'text-dark/50'}`}>
